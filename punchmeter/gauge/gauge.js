// MIT License https://github.com/bernii/gauge.js/blob/gh-pages/README.md
;(function () {
  var t,
    i,
    e,
  ...
  !(function () {
    ...
    (e = (function (t) {
      ...
      return (
        ...
        (i.prototype.setOptions = function (t) {
          return null == t && (t = null), (this.options = c(this.options, t)), this.textField && (this.textField.el.style.fontSize = t.fontSize + 'px'), this.options.angle > 0.5 && (this.options.angle = 0.5), this.configDisplayScale(), this
        }),
      ...
      (h = (function () {
        ...
        return (
          ...
          (t.prototype.update = function (t) {
            var i
            return null == t && (t = !1), !(!t && this.displayedValue === this.value) && (this.ctx && this.clear && this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height), (i = this.value - this.displayedValue), Math.abs(i / this.animationSpeed) <= 0.001 ? (this.displayedValue = this.value) : (this.displayedValue = this.displayedValue + i / this.animationSpeed), this.render(), !0)
          }),
          t
        )
      })()),
    ...
    (function () {
      ...
      ;(t.prototype.updateValues = function (t) {
        ...
        (t.prototype.render = function () {
          var t, i
          return this.textField && this.textField.text(p(this.value)), 0 === this.maxValue && (this.maxValue = 2 * this.avgValue), (i = (this.value / this.maxValue) * 100), (t = (this.avgValue / this.maxValue) * 100), $('.bar-value', this.elem).css({ width: i + '%' }), $('.typical-value', this.elem).css({ width: t + '%' })
        })
    })(),
    (n = (function (t) {
      function i(t) {
      ...
      return (
        ...
        (i.prototype.options = { colorStart: '#6fadcf', colorStop: void 0, gradientType: 0, strokeColor: '#e0e0e0', pointer: { length: 0.8, strokeWidth: 0.035, iconScale: 1 }, angle: 0.15, lineWidth: 0.44, radiusScale: 1, fontSize: 40, limitMax: !1, limitMin: !1 }),
        (i.prototype.setOptions = function (t) {
          var e, s, n, o, a
        ...
        (i.prototype.configPercentColors = function () {
          ...
          if (((this.percentColors = null), void 0 !== this.options.percentColors)) {
            for (this.percentColors = new Array(), o = [], e = s = 0, n = this.options.percentColors.length - 1; 0 <= n ? s <= n : s >= n; e = 0 <= n ? ++s : --s) (a = parseInt(l(this.options.percentColors[e][1]).substring(0, 2), 16)), (i = parseInt(l(this.options.percentColors[e][1]).substring(2, 4), 16)), (t = parseInt(l(this.options.percentColors[e][1]).substring(4, 6), 16)), o.push((this.percentColors[e] = { pct: this.options.percentColors[e][0], color: { r: a, g: i, b: t } }))
            return o
          }
        }),
        (i.prototype.set = function (t) {
          ...
          if (t.length > this.gp.length) for (e = n = 0, l = t.length - this.gp.length; 0 <= l ? n < l : n > l; e = 0 <= l ? ++n : --n) (i = new o(this)).setOptions(this.options.pointer), this.gp.push(i)
          else t.length < this.gp.length && (this.gp = this.gp.slice(this.gp.length - t.length))
          for (e = 0, a = 0, h = t.length; a < h; a++) (p = t[a]) > this.maxValue ? (this.options.limitMax ? (p = this.maxValue) : (this.maxValue = p + 1)) : p < this.minValue && (this.options.limitMin ? (p = this.minValue) : (this.minValue = p - 1)), (this.gp[e].value = p), this.gp[e++].setOptions({ minValue: this.minValue, maxValue: this.maxValue, angle: this.options.angle })
          ...
          if (0 === t) e = this.percentColors[0].color
            ...
            for (e = this.percentColors[this.percentColors.length - 1].color, n = o = 0, h = this.percentColors.length - 1; 0 <= h ? o <= h : o >= h; n = 0 <= h ? ++o : --o)
              if (t <= this.percentColors[n].pct) {
                !0 === i ? ((r = this.percentColors[n - 1] || this.percentColors[0]), (s = this.percentColors[n]), (a = (t - r.pct) / (s.pct - r.pct)), (e = { r: Math.floor(r.color.r * (1 - a) + s.color.r * a), g: Math.floor(r.color.g * (1 - a) + s.color.g * a), b: Math.floor(r.color.b * (1 - a) + s.color.b * a) })) : (e = this.percentColors[n].color)
                break
              }
    ...
    (i = (function (t) {
      ...
      return (
        ...
        (i.prototype.maxValue = 80),
        (i.prototype.minValue = 0),
        (i.prototype.options = { lineWidth: 0.1, colorStart: '#6f6ea0', colorStop: '#c0c0db', strokeColor: '#eeeeee', shadowColor: '#d5d5d5', angle: 0.35, radiusScale: 1 }),
        (i.prototype.getAngle = function (t) {
    ...
    (s = (function (t) {
      ...
      return (
        ...
        (i.prototype.strokeGradient = function (t, i, e, s) {
          var n
          return (n = this.ctx.createRadialGradient(t, i, e, t, i, s)).addColorStop(0, this.options.shadowColor), n.addColorStop(0.12, this.options._orgStrokeColor), n.addColorStop(0.88, this.options._orgStrokeColor), n.addColorStop(1, this.options.shadowColor), n
        }),
        (i.prototype.setOptions = function (t) {
          var e, s, n, o
