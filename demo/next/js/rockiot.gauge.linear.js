      ...
      var e = {
          ...
          watch: {
            '$attrs.value': function (t) {
              parseFloat(t) > parseInt(this.$attrs.max) ? (this.pos = this.normalize(parseFloat(this.$attrs.max)) * this.posFactor) : (this.pos = this.normalize(t) * this.posFactor), (this.aniValue = t)
            },
            $attrs: function (t) {
            ...
            createScale: function () {
              ...
              for (var t = 'http://www.w3.org/2000/svg', s = parseInt(this.svgheight) - 2 * this.offsetY, i = parseInt(this.$attrs.smallscale) ? 10 : 1, e = parseInt(this.$attrs.ticks) * i, a = s / parseInt(this.$attrs.ticks) / i, r = 0, h = 0; h <= e; h++) {
                ...
                if (i > 1) {
                  n = h % 10 != 0 && h > 0 ? 10 : 15
                  this.svgwidth
                  var o = { class: 'scale rockiot-scale', style: this.scaleStyle, x1: this.scaleX, y1: h * a + this.offsetY, x2: this.scaleX + n, y2: h * a + this.offsetY }
                  this.setSVGAttributes(l, o), this.svg.scale.appendChild(l)
                } else {
                  this.svgwidth, (o = { class: 'scale rockiot-scale', style: this.scaleStyle, x1: this.scaleX, y1: h * a + this.offsetY, x2: this.scaleX + n, y2: h * a + this.offsetY })
                  this.setSVGAttributes(l, o), this.svg.scale.appendChild(l)
                }
              ...
              if (this.showScale) {
                ...
                for (var t = 'http://www.w3.org/2000/svg', s = (parseInt(this.svgwidth) - this.offsetX - this.offsetX) / parseInt(this.$attrs.ticks) / 10, i = 0, e = 0, a = 0; i <= 10 * parseInt(this.$attrs.ticks); a += s) {
                  ...
                  if (parseInt(this.$attrs.smallscale) && i % 10 != 0 && i > 0) {
                    h = 0
                    var n = { class: (l = 'scale scale-minor-ticks'), style: this.scaleStyle, x1: a + this.offsetX, y1: this.offsetY, x2: a + this.offsetX, y2: this.offsetY - 20 - h + this.scaleY }
                    this.setSVGAttributes(r, n), this.svg.scale.appendChild(r)
                  }
                  if (i % 10 == 0 || 0 === i) {
                    n = { class: l, style: this.scaleStyle, x1: a + this.offsetX, y1: this.offsetY, x2: a + this.offsetX, y2: this.offsetY - 20 - h + this.scaleY }
                    this.setSVGAttributes(r, n), this.svg.scale.appendChild(r)
                  }
                  if (i % 10 == 0 || 0 === i) {
