...
export default (function (global, factory) {
  ...
  ;(function (globalRoot, Rockiotchart) {
    ...
    Rockiotchart.createSvg = function (container, width, height, className) {
      ...
      Array.prototype.slice
        ...
        .filter(function filterRockiotchartSvgObjects(svg) {
    ...
    Rockiotchart.normalizeData = function (data, reverse, multi) {
      ...
      Array.prototype.push.apply(
        ...
        Rockiotchart.times(Math.max(0, labelCount - output.normalized.labels.length)).map(function () {
          return ''
        }),
      )
  ...
  ;(function (globalRoot, Rockiotchart) {
    ...
    function SvgList(nodeList) {
      ...
      Object.keys(Rockiotchart.Svg.prototype)
  ...
  ;(function (globalRoot, Rockiotchart) {
    ...
    function FixedScaleAxis(axisUnit, data, chartRect, options) {
      ...
      this.ticks =
        options.ticks ||
        Rockiotchart.times(this.divisor).map(
  ...
  ;(function (globalRoot, Rockiotchart) {
    ...
    function createChart(options) {
      ...
      if (options.axisX.type === undefined) {
        axisX = new Rockiotchart.StepAxis(
          Rockiotchart.Axis.units.x,
          data.normalized.series,
          chartRect,
          Rockiotchart.extend({}, options.axisX, {
      ...
      if (options.axisY.type === undefined) {
        axisY = new Rockiotchart.AutoScaleAxis(
          Rockiotchart.Axis.units.y,
          data.normalized.series,
          chartRect,
          Rockiotchart.extend({}, options.axisY, {
  ...
  ;(function (globalRoot, Rockiotchart) {
    ...
    function createChart(options) {
      ...
      if (options.horizontalBars) {
        if (options.axisX.type === undefined) {
          valueAxis = axisX = new Rockiotchart.AutoScaleAxis(
            Rockiotchart.Axis.units.x,
            data.normalized.series,
            chartRect,
            Rockiotchart.extend({}, options.axisX, {
        ...
        if (options.axisY.type === undefined) {
          valueAxis = axisY = new Rockiotchart.AutoScaleAxis(
            Rockiotchart.Axis.units.y,
            data.normalized.series,
            chartRect,
            Rockiotchart.extend({}, options.axisY, {
